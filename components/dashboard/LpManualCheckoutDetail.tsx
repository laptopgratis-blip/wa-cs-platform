        ...
        <CardContent className="space-y-5 p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-warm-600">
                <span className="rounded bg-warm-100 px-2 py-0.5 font-mono font-semibold">
                ...
                <span className="flex items-center gap-1">
                  <HardDrive className="size-3" /> {payment.package.maxStorageMB} MB
                </span>
              </div>
            </div>
            <Badge
          ...
          <div className="rounded-lg border-2 border-dashed border-primary-300 bg-primary-50/50 p-4">
            ...
            <div className="mt-1 flex items-baseline gap-3">
              ...
              <Button
                ...
                onClick={() => copy(String(payment.totalAmount), 'Nominal transfer')}
              >
