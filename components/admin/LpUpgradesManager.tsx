...
export function LpUpgradesManager() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Verifikasi Upgrade Landing Page"
        description="Manual: cocokkan bukti dengan total + kode unik, lalu konfirmasi. Tripay: status auto-update via webhook (read-only)."
      />
              ...
              <TableRow>
                <TableCell colSpan={7}>
                  <EmptyState
                    ...
                    description="Pembayaran upgrade LP yang masuk bakal tampil di tab ini."
                  />
                </TableCell>
              </TableRow>
            ) : (
