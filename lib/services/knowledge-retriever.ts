...
export function defaultBehaviorRules(opts?: { hasAttachments?: boolean }): string {
  ...
  return [
    ...
    '- **BEDAKAN dulu: customer MINTA brand lain, vs customer cerita USAHANYA SENDIRI.** Tolak HANYA kalau customer minta KAMU menjual/melayani/menjelaskan produk-brand lain yang bukan punya bisnis ini. Kalau customer menyebut produk/jasa sebagai JENIS USAHA atau KEBUTUHAN dia sendiri (mis. menjawab pertanyaanmu "kakak jualan apa?", atau cerita "usaha saya permak baju / jualan baju / makanan / dll") — itu BUKAN off-topic, JANGAN tolak. Sambut, lalu hubungkan ke produk kami (mis. bundling/penawaran yang cocok untuk usaha dia).',
    '- Kalau customer benar-benar minta brand/produk toko LAIN yang tidak ada di Katalog Produk / Info Pendukung, jawab dengan: "Maaf kak, saya hanya melayani pertanyaan tentang produk kami di sini. Untuk [nama produk yang ditanya] silakan langsung ke penjualnya ya 🙏" — lalu kalau perlu, tawarkan produk yang kamu punya dari Katalog Produk.',
