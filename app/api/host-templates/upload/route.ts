// POST /api/host-templates/upload — upload referensi gambar oleh user
// (versi non-admin). Mirror dari /api/admin/host-templates/upload tapi
// requireSession bukan requireAdmin.
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error('[POST /api/host-templates/upload] gagal:', err)
